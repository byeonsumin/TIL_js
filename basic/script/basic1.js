...
console.log(a); //console이라는 객체에 a라는 변수를 남기겠다
var b = 10; //초기값부터 정의됨
a = b; //10
a = 20; //값이 정의됨
console.log(a, b);
...
b = '1'
console.log('a와 b를 더한 결과는',(a+b),'이고 데이터타입은',typeof('a+b'),'다.'); // 20+'1'= 201
...
cart = null; //cart = ''; //장바구니 비우기(삭제버튼 클릭시)
console.log(cart);
...
// const que1 = Number(prompt('1+1은?')); //Number = 숫자 변경 함수
// console.log(que1);
// console.log(typeof(que1)); //number
// confirm(que1);

//const kurly_order_num = Number(prompt('주문수량은?'));
//const kurly_price = 10000;
//const kurly_total = kurly_price * kurly_order_num;
//console.log(typeof(kurly_order_num)); //string -> number로 변환하기
//console.log(`주문수량은 ${kurly_order_num}, 총 주문가는 ${kurly_total}원입니다.`);

// 구구단
const dan99 = Number(prompt('구구단 몇단이 궁금해요?')); // 숫자로 변환
