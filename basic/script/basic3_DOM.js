...
//DOM
const btn = document.getElementsByTagName('button') //태그는 문자열에 해당되어서 무조건 따옴표('') 작성
...
// 아이디는 단 하나의 요소이기 때문에, 인덱스를 붙이지 않고 작성한다.
slide_container.style.filter = 'invert(1)';

// ES6 querySelector
const tag_es6 = document.querySelectorAll('div') //All로 전체 다 잡기
const cls_es6 = document.querySelectorAll('.slide') //All로 전체 다 잡기
const id_es6 = document.querySelector('#slide_container') //하나밖에 없어서 얘는 All금지
...
const navLi_v2 = navGnb.querySelectorAll('li') //document(body) 대신, navGnb를 사용하여 li넣어주기
